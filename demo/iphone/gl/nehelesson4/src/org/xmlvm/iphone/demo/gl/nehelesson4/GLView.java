...
public abstract class GLView extends UIView {
    ...
    public boolean createFrameBuffer() {
    	...
    	context.renderBufferStorage(GL.GL_RENDERBUFFER_OES, (EAGLDrawable) getEAGLLayer().getDrawable());
...
//    	glGetRenderbufferParameterivOES(GL_RENDERBUFFER_OES, GL_RENDERBUFFER_HEIGHT_OES, &backingHeight);
    	...
    	if(GL.glCheckFramebufferStatusOES(GL.GL_FRAMEBUFFER_OES) != GL.GL_FRAMEBUFFER_COMPLETE_OES) {
    		System.out.println("failed to make complete framebuffer object "+GL.glCheckFramebufferStatusOES(GL.GL_FRAMEBUFFER_OES));
    		return false;
    	}
