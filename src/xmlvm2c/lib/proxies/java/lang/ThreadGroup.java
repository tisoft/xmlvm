...
public class ThreadGroup implements Thread.UncaughtExceptionHandler {
    ...
    public ThreadGroup(ThreadGroup parent, String name) {
        ...
        if (Thread.currentThread() != null) {
            ...
            if (parent == null) {
                // For XMLVM, I had to specifically throw a
                // NullPointerException, because after converting to C code, a
                // "Segmentation fault" would occur rather than throwing a
                // NullPointerException when a method is invoked on a null
                // Object.
