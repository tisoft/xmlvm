...
{
	org_xmlvm_ios_AudioFile_SMPTE_Time* cObj = obj;
	AudioFile_SMPTE_Time toRet;
	toRet.mHours = cObj->fields.org_xmlvm_ios_AudioFile_SMPTE_Time.mHours_;
	toRet.mMinutes = cObj->fields.org_xmlvm_ios_AudioFile_SMPTE_Time.mMinutes_;
	toRet.mSeconds = cObj->fields.org_xmlvm_ios_AudioFile_SMPTE_Time.mSeconds_;
	toRet.mFrames = cObj->fields.org_xmlvm_ios_AudioFile_SMPTE_Time.mFrames_;
	toRet.mSubFrameSampleOffset = cObj->fields.org_xmlvm_ios_AudioFile_SMPTE_Time.mSubFrameSampleOffset_;
	return toRet;
}
