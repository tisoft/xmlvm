...
{
	org_xmlvm_ios_AudioUnitParameterInfo* cObj = obj;
	AudioUnitParameterInfo toRet;
	toRet.unitName = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.unitName_;
	toRet.clumpID = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.clumpID_;
	toRet.cfNameString = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.cfNameString_;
	toRet.unit = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.unit_;
	toRet.minValue = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.minValue_;
	toRet.maxValue = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.maxValue_;
	toRet.defaultValue = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.defaultValue_;
	toRet.flags = cObj->fields.org_xmlvm_ios_AudioUnitParameterInfo.flags_;
	return toRet;
}
