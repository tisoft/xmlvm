...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation \
    } org_xmlvm_iphone_UIDeviceOrientation

struct org_xmlvm_iphone_UIDeviceOrientation {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIDeviceOrientation* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceOrientation;
};
