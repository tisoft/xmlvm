...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIProgressView, 15, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIProgressView)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIProgressView 15
...
#define XMLVM_OBJC_OVERRIDE_CLASS_DECLARATIONS_org_xmlvm_iphone_UIProgressView \
XMLVM_OBJC_OVERRIDE_CLASS_DECLARATIONS_org_xmlvm_iphone_UIControl \

// Define a Macro for the entire contents of the Obj-C wrapper class
#define XMLVM_OBJC_OVERRIDE_CLASS_DEFINITIONS_org_xmlvm_iphone_UIProgressView \
