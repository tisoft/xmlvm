...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIProgressView, 74)

//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressView
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressView \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIControl; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressView \
    } org_xmlvm_iphone_UIProgressView

struct org_xmlvm_iphone_UIProgressView {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIProgressView* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressView;
};
