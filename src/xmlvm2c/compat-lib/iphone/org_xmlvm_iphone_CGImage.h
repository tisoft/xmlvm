...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGImage
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_CGImage \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGImage \
    } org_xmlvm_iphone_CGImage

struct org_xmlvm_iphone_CGImage {
    __CLASS_DEFINITION_org_xmlvm_iphone_CGImage* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_CGImage;
};
#ifndef XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGImage
#define XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGImage
