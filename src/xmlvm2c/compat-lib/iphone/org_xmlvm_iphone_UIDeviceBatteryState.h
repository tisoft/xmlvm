...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceBatteryState
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceBatteryState \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceBatteryState \
    } org_xmlvm_iphone_UIDeviceBatteryState

struct org_xmlvm_iphone_UIDeviceBatteryState {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIDeviceBatteryState* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDeviceBatteryState;
};
