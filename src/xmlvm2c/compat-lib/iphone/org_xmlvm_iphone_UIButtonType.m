...
__CLASS_DEFINITION_org_xmlvm_iphone_UIButtonType __CLASS_org_xmlvm_iphone_UIButtonType = {
    0, // classInitialized
...
{
    __CLASS_org_xmlvm_iphone_UIButtonType.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    __CLASS_org_xmlvm_iphone_UIButtonType.newInstanceFunc = __NEW_INSTANCE_org_xmlvm_iphone_UIButtonType;
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_org_xmlvm_iphone_UIButtonType.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_org_xmlvm_iphone_UIButtonType.numImplementedInterfaces = 0;
    __CLASS_org_xmlvm_iphone_UIButtonType.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
