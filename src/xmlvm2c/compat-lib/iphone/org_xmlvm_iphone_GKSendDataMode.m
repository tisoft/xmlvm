...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_GKSendDataMode_ARRAYTYPE;
...
void __INIT_IMPL_org_xmlvm_iphone_GKSendDataMode()
{
    if (!__TIB_org_xmlvm_iphone_GKSendDataMode.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_GKSendDataMode_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKSendDataMode, 1);
