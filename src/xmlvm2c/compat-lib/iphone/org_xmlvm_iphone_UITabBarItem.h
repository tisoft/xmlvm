...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITabBarItem, 7, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITabBarItem)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITabBarItem 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITabBarItem_setTitle___java_lang_String 6
