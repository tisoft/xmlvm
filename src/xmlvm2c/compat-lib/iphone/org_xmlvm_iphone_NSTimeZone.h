...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSTimeZone, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSTimeZone)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSTimeZone 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSTimeZone_name__ 9
