...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) org_xmlvm_iphone_MKUserLocation_getLocation__(receiver);
        break;
    case 1:
        conversion.i = (JAVA_BOOLEAN) org_xmlvm_iphone_MKUserLocation_isUpdating__(receiver);
        result = __NEW_java_lang_Boolean();
        java_lang_Boolean___INIT____boolean(result, conversion.i);
        break;
    case 2:
        result = (JAVA_OBJECT) org_xmlvm_iphone_MKUserLocation_getSubtitle__(receiver);
        break;
    case 3:
        org_xmlvm_iphone_MKUserLocation_setSubtitle___java_lang_String(receiver, argsArray[0]);
        break;
    case 4:
        result = (JAVA_OBJECT) org_xmlvm_iphone_MKUserLocation_getTitle__(receiver);
        break;
    case 5:
        org_xmlvm_iphone_MKUserLocation_setTitle___java_lang_String(receiver, argsArray[0]);
        break;
    case 6:
        result = (JAVA_OBJECT) org_xmlvm_iphone_MKUserLocation_getCoordinate__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_MKUserLocation);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_MKUserLocation.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_MKUserLocation.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_MKUserLocation);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_MKUserLocation.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_MKUserLocation.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_MKUserLocation.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.MKUserLocation")
...
void __INIT_IMPL_org_xmlvm_iphone_MKUserLocation()
{
    ...
    __TIB_org_xmlvm_iphone_MKUserLocation.vtable[7] = (VTABLE_PTR) &org_xmlvm_iphone_MKUserLocation_getCoordinate__;
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MKUserLocation(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MKUserLocation]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_MKUserLocation()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_MKUserLocation)
org_xmlvm_iphone_MKUserLocation* me = (org_xmlvm_iphone_MKUserLocation*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_MKUserLocation));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_MKUserLocation(me, 0);
