...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MPMovieScalingMode
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_MPMovieScalingMode \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MPMovieScalingMode \
    } org_xmlvm_iphone_MPMovieScalingMode

struct org_xmlvm_iphone_MPMovieScalingMode {
    __CLASS_DEFINITION_org_xmlvm_iphone_MPMovieScalingMode* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_MPMovieScalingMode;
};
