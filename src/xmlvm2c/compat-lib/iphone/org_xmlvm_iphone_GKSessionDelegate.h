...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_GKSessionDelegate, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_GKSessionDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_GKSessionDelegate 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKSessionDelegate_didChangeState___org_xmlvm_iphone_GKSession_java_lang_String_int 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKSessionDelegate_didReceiveConnectionRequestFromPeer___org_xmlvm_iphone_GKSession_java_lang_String 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKSessionDelegate_connectionWithPeerFailed___org_xmlvm_iphone_GKSession_java_lang_String_org_xmlvm_iphone_NSError 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKSessionDelegate_didFailWithError___org_xmlvm_iphone_GKSession_org_xmlvm_iphone_NSError 8
