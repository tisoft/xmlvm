...
static XMLVM_METHOD_REFLECTION_DATA __method_reflection_data[] = {
    ...
    0,
    0,
    "()Lorg/xmlvm/iphone/gl/CAEAGLLayer;",
    JAVA_NULL,
    JAVA_NULL},
};
...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) org_xmlvm_iphone_UIViewGL_getEAGLLayer__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
void __INIT_org_xmlvm_iphone_UIViewGL()
{
    ...
    if (initBegan) {
        ...
        XMLVM_CLASS_USED("org.xmlvm.iphone.UIViewGL")
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UIViewGL)
