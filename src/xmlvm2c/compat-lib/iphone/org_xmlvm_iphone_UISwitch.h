...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UISwitch, 74)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UISwitch 74
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UISwitch_setOn___boolean 72
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UISwitch_isOn__ 73
