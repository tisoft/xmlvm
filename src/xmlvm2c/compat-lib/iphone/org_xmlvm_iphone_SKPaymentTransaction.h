...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransaction
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransaction \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransaction \
    } org_xmlvm_iphone_SKPaymentTransaction

struct org_xmlvm_iphone_SKPaymentTransaction {
    __CLASS_DEFINITION_org_xmlvm_iphone_SKPaymentTransaction* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_SKPaymentTransaction;
};
#ifndef XMLVM_FORWARD_DECL_org_xmlvm_iphone_SKPaymentTransaction
#define XMLVM_FORWARD_DECL_org_xmlvm_iphone_SKPaymentTransaction
