...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.UITableViewCellSeparatorStyle")
...
void __INIT_IMPL_org_xmlvm_iphone_UITableViewCellSeparatorStyle()
{
    ...
    __TIB_org_xmlvm_iphone_UITableViewCellSeparatorStyle.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle);
    __CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle_1ARRAY);
    __CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITableViewCellSeparatorStyle_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellSeparatorStyle(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellSeparatorStyle]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_UITableViewCellSeparatorStyle()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UITableViewCellSeparatorStyle)
org_xmlvm_iphone_UITableViewCellSeparatorStyle* me = (org_xmlvm_iphone_UITableViewCellSeparatorStyle*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_UITableViewCellSeparatorStyle));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellSeparatorStyle(me, 0);
