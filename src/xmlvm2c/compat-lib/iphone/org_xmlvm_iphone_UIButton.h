...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIButton, 93)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIButton 93
...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIButton_setAlpha___float 46
