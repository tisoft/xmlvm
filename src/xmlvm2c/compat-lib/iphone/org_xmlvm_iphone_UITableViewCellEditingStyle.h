...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellEditingStyle
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellEditingStyle \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellEditingStyle \
    } org_xmlvm_iphone_UITableViewCellEditingStyle

struct org_xmlvm_iphone_UITableViewCellEditingStyle {
    __CLASS_DEFINITION_org_xmlvm_iphone_UITableViewCellEditingStyle* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewCellEditingStyle;
};
