...
void __INIT_IMPL_org_xmlvm_iphone_NSError_Domain()
{
    ...
    _STATIC_org_xmlvm_iphone_NSError_Domain_NSCocoa = (java_lang_String*) xmlvm_create_java_string_from_pool(25);
    _STATIC_org_xmlvm_iphone_NSError_Domain_NSURL = (java_lang_String*) xmlvm_create_java_string_from_pool(26);
    _STATIC_org_xmlvm_iphone_NSError_Domain_NSPOSIX = (java_lang_String*) xmlvm_create_java_string_from_pool(27);
    _STATIC_org_xmlvm_iphone_NSError_Domain_NSOSStatus = (java_lang_String*) xmlvm_create_java_string_from_pool(28);
    _STATIC_org_xmlvm_iphone_NSError_Domain_NSMach = (java_lang_String*) xmlvm_create_java_string_from_pool(29);
