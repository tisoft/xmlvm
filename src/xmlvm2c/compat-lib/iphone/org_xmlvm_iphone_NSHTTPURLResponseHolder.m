...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.NSHTTPURLResponseHolder")
...
void __INIT_IMPL_org_xmlvm_iphone_NSHTTPURLResponseHolder()
{
    ...
    __TIB_org_xmlvm_iphone_NSHTTPURLResponseHolder.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder);
    __CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder_1ARRAY);
    __CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSHTTPURLResponseHolder_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSHTTPURLResponseHolder(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSHTTPURLResponseHolder]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_NSHTTPURLResponseHolder()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_NSHTTPURLResponseHolder)
org_xmlvm_iphone_NSHTTPURLResponseHolder* me = (org_xmlvm_iphone_NSHTTPURLResponseHolder*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_NSHTTPURLResponseHolder));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSHTTPURLResponseHolder(me, 0);
