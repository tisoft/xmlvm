...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UIPreferencesTableCell);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UIPreferencesTableCell);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UIPreferencesTableCell.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UIPreferencesTableCell.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_UIPreferencesTableCell.initializerThreadId = curThreadId;
...
void __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTableCell()
{
    ...
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[66] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setTitle___java_lang_String;
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[67] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_getTitle__;
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[68] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setEnabled___boolean;
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[69] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_setGroupCell___boolean;
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.vtable[70] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTableCell_isGroupCell__;
    ...
    __TIB_org_xmlvm_iphone_UIPreferencesTableCell.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell);
    __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell_1ARRAY);
    __CLASS_org_xmlvm_iphone_UIPreferencesTableCell_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTableCell_2ARRAY);
