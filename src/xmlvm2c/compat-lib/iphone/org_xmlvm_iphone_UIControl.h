...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIControl, 70)
...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIControl_addTarget___org_xmlvm_iphone_UIControlDelegate_int 69
