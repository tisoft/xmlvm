...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse \
    } org_xmlvm_iphone_SKProductsResponse

struct org_xmlvm_iphone_SKProductsResponse {
    __CLASS_DEFINITION_org_xmlvm_iphone_SKProductsResponse* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse;
};
