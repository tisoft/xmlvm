...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIView, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIView)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIView 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIView_setAlpha___float 8
