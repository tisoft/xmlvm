...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIActivityIndicatorViewStyle
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIActivityIndicatorViewStyle \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIActivityIndicatorViewStyle \
    } org_xmlvm_iphone_UIActivityIndicatorViewStyle

struct org_xmlvm_iphone_UIActivityIndicatorViewStyle {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIActivityIndicatorViewStyle* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIActivityIndicatorViewStyle;
};
