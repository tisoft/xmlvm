...
__CLASS_DEFINITION_org_xmlvm_iphone_CGPathDrawingMode __CLASS_org_xmlvm_iphone_CGPathDrawingMode = {
    0, // classInitialized
...
{
    __CLASS_org_xmlvm_iphone_CGPathDrawingMode.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    __CLASS_org_xmlvm_iphone_CGPathDrawingMode.newInstanceFunc = __NEW_INSTANCE_org_xmlvm_iphone_CGPathDrawingMode;
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_org_xmlvm_iphone_CGPathDrawingMode.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_org_xmlvm_iphone_CGPathDrawingMode.numImplementedInterfaces = 0;
    __CLASS_org_xmlvm_iphone_CGPathDrawingMode.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
...
GC_CALLBACK __DELETE_org_xmlvm_iphone_CGPathDrawingMode(void * me, void * client_data)
{
...
{
    if (!__CLASS_org_xmlvm_iphone_CGPathDrawingMode.classInitialized) __INIT_org_xmlvm_iphone_CGPathDrawingMode();
    ...
    me->__class = &__CLASS_org_xmlvm_iphone_CGPathDrawingMode;
    //XMLVM_BEGIN_WRAPPER[__NEW_org_xmlvm_iphone_CGPathDrawingMode]
    //XMLVM_END_WRAPPER
    // Tell the GC to finalize us
    XMLVM_FINALIZE(me, __DELETE_org_xmlvm_iphone_CGPathDrawingMode);
    return me;
}
