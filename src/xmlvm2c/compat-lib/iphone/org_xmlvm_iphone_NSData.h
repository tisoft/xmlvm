...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSData, 12, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSData)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSData 12
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSData_writeToFile___java_lang_String_boolean 9
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSData_length__ 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSData_getBytes__ 11
