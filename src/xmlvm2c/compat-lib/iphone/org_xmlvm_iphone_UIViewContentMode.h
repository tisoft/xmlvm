...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewContentMode
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewContentMode \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewContentMode \
    } org_xmlvm_iphone_UIViewContentMode

struct org_xmlvm_iphone_UIViewContentMode {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIViewContentMode* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewContentMode;
};
