...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_SystemSoundID);
    if (!__TIB_org_xmlvm_iphone_SystemSoundID.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_SystemSoundID();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_SystemSoundID);
}

void __INIT_IMPL_org_xmlvm_iphone_SystemSoundID()
{
    if (!__TIB_org_xmlvm_iphone_SystemSoundID.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_SystemSoundID_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SystemSoundID, 3);
        __CLASS_org_xmlvm_iphone_SystemSoundID_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SystemSoundID, 2);
        __CLASS_org_xmlvm_iphone_SystemSoundID_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SystemSoundID, 1);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SystemSoundID(JAVA_OBJECT me)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_SystemSoundID()
{
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SystemSoundID(me);
