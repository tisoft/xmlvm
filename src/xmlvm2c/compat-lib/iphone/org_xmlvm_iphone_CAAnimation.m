...
void __INIT_org_xmlvm_iphone_CAAnimation()
{
    ...
    __INIT_org_xmlvm_iphone_CAMediaTiming(&__TIB_org_xmlvm_iphone_CAAnimation.implementedInterfaces[0][0]);
    ...
    __INIT_org_xmlvm_iphone_CAAction(&__TIB_org_xmlvm_iphone_CAAnimation.implementedInterfaces[0][1]);
