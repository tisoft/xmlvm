...
void __INIT_IMPL_org_xmlvm_iphone_UIImagePickerController()
{
    ...
    _STATIC_org_xmlvm_iphone_UIImagePickerController_MediaType = (java_lang_String*) xmlvm_create_java_string_from_pool(30);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_OriginalImage = (java_lang_String*) xmlvm_create_java_string_from_pool(31);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_EditedImage = (java_lang_String*) xmlvm_create_java_string_from_pool(32);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_CropRect = (java_lang_String*) xmlvm_create_java_string_from_pool(33);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_MediaURL = (java_lang_String*) xmlvm_create_java_string_from_pool(34);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_ReferenceURL = (java_lang_String*) xmlvm_create_java_string_from_pool(35);
    _STATIC_org_xmlvm_iphone_UIImagePickerController_MediaMetadata = (java_lang_String*) xmlvm_create_java_string_from_pool(36);
