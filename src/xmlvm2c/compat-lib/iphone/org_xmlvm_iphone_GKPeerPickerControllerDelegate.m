...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_GKPeerPickerControllerDelegate_ARRAYTYPE;
...
void __INIT_IMPL_org_xmlvm_iphone_GKPeerPickerControllerDelegate()
{
    if (!__TIB_org_xmlvm_iphone_GKPeerPickerControllerDelegate.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_GKPeerPickerControllerDelegate_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerPickerControllerDelegate, 1);
