...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarButtonItemStyle
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarButtonItemStyle \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarButtonItemStyle \
    } org_xmlvm_iphone_UIBarButtonItemStyle

struct org_xmlvm_iphone_UIBarButtonItemStyle {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIBarButtonItemStyle* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarButtonItemStyle;
};
