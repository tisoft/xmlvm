...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_SKRequest_ARRAYTYPE;
...
void __INIT_org_xmlvm_iphone_SKRequest()
{
    ...
    __CLASS_org_xmlvm_iphone_SKRequest_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKRequest, 1);
