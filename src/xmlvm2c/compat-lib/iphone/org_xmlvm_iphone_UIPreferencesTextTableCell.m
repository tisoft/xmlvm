...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.classInitialized) {
                // do nothing
            }
        }
    } else {
...
void __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTextTableCell()
{
    ...
    __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[71] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_setValue___java_lang_String;
    __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[72] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_getValue__;
    __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.vtable[73] = (VTABLE_PTR) &org_xmlvm_iphone_UIPreferencesTextTableCell_xmlvmKeyTyped___char;
    ...
    __TIB_org_xmlvm_iphone_UIPreferencesTextTableCell.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell);
    __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_1ARRAY);
    __CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTextTableCell_2ARRAY);
