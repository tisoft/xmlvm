...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) org_xmlvm_iphone_SKProductsResponse_getInvalidProductIdentifiers__(receiver);
        break;
    case 1:
        result = (JAVA_OBJECT) org_xmlvm_iphone_SKProductsResponse_getProducts__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_SKProductsResponse);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_SKProductsResponse.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_SKProductsResponse.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_SKProductsResponse);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_SKProductsResponse.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_SKProductsResponse.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_SKProductsResponse.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.SKProductsResponse")
...
void __INIT_IMPL_org_xmlvm_iphone_SKProductsResponse()
{
    ...
    __TIB_org_xmlvm_iphone_SKProductsResponse.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_SKProductsResponse_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_SKProductsResponse);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_SKProductsResponse()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_SKProductsResponse)
org_xmlvm_iphone_SKProductsResponse* me = (org_xmlvm_iphone_SKProductsResponse*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_SKProductsResponse));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_SKProductsResponse(me, 0);
