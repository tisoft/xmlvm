...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebViewNavigationType
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebViewNavigationType \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebViewNavigationType \
    } org_xmlvm_iphone_UIWebViewNavigationType

struct org_xmlvm_iphone_UIWebViewNavigationType {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIWebViewNavigationType* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebViewNavigationType;
};
