...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITextView, 12, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITextView)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITextView 12
