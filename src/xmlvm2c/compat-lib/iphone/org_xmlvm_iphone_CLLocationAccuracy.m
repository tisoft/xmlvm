...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_CLLocationAccuracy);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_CLLocationAccuracy.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_CLLocationAccuracy.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_CLLocationAccuracy);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_CLLocationAccuracy.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_CLLocationAccuracy.classInitialized) {
                // do nothing
            }
        }
    } else {
...
void __INIT_IMPL_org_xmlvm_iphone_CLLocationAccuracy()
{
    ...
    __TIB_org_xmlvm_iphone_CLLocationAccuracy.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_CLLocationAccuracy_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationAccuracy);
    __CLASS_org_xmlvm_iphone_CLLocationAccuracy_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationAccuracy_1ARRAY);
    __CLASS_org_xmlvm_iphone_CLLocationAccuracy_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CLLocationAccuracy_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CLLocationAccuracy(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_CLLocationAccuracy]
    //XMLVM_END_WRAPPER
}
