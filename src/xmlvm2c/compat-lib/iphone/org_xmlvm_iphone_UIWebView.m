...
static XMLVM_METHOD_REFLECTION_DATA __method_reflection_data[] = {
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/NSURLRequest;)V",
    JAVA_NULL,
    JAVA_NULL},
    {"loadHTMLString",
    ...
    0,
    0,
    "()Lorg/xmlvm/iphone/NSURLRequest;",
    JAVA_NULL,
    JAVA_NULL},
    ...
    0,
    0,
    "()Lorg/xmlvm/iphone/UIWebViewDelegate;",
    JAVA_NULL,
    JAVA_NULL},
    {"setDelegate",
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/UIWebViewDelegate;)V",
    JAVA_NULL,
    JAVA_NULL},
    {"reload",
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UIWebView);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UIWebView.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UIWebView.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UIWebView);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UIWebView.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UIWebView.classInitialized) {
                // do nothing
            }
        }
    } else {
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebView(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIWebView]
    //XMLVM_END_WRAPPER
}
