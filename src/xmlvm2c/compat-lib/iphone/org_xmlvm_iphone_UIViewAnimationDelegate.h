...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewAnimationDelegate
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewAnimationDelegate \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewAnimationDelegate \
    } org_xmlvm_iphone_UIViewAnimationDelegate

struct org_xmlvm_iphone_UIViewAnimationDelegate {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIViewAnimationDelegate* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIViewAnimationDelegate;
};
