...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITouchPhase
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UITouchPhase \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITouchPhase \
    } org_xmlvm_iphone_UITouchPhase

struct org_xmlvm_iphone_UITouchPhase {
    __CLASS_DEFINITION_org_xmlvm_iphone_UITouchPhase* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UITouchPhase;
};
