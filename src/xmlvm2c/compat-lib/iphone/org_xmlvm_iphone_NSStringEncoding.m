...
__CLASS_DEFINITION_org_xmlvm_iphone_NSStringEncoding __CLASS_org_xmlvm_iphone_NSStringEncoding = {
    0, // classInitialized
...
{
    __CLASS_org_xmlvm_iphone_NSStringEncoding.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    __CLASS_org_xmlvm_iphone_NSStringEncoding.newInstanceFunc = __NEW_INSTANCE_org_xmlvm_iphone_NSStringEncoding;
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_org_xmlvm_iphone_NSStringEncoding.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_org_xmlvm_iphone_NSStringEncoding.numImplementedInterfaces = 0;
    __CLASS_org_xmlvm_iphone_NSStringEncoding.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
...
{
    if (!__CLASS_org_xmlvm_iphone_NSStringEncoding.classInitialized) __INIT_org_xmlvm_iphone_NSStringEncoding();
...
void __DELETE_org_xmlvm_iphone_NSStringEncoding(JAVA_OBJECT me)
{
