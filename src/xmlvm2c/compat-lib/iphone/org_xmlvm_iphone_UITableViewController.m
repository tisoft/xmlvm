...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        ...
        break;
    case 1:
        result = (JAVA_OBJECT) org_xmlvm_iphone_UITableViewController_getTableView__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
void __INIT_org_xmlvm_iphone_UITableViewController()
{
    ...
    if (initBegan) {
        ...
        XMLVM_CLASS_USED("org.xmlvm.iphone.UITableViewController")
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UITableViewController)
