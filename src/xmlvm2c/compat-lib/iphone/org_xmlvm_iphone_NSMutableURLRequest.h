...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSMutableURLRequest, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSMutableURLRequest)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSMutableURLRequest 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSMutableURLRequest_addValueForHTTPHeaderField___java_lang_String_java_lang_String 9
