...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGDataProvider
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_CGDataProvider \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGDataProvider \
    } org_xmlvm_iphone_CGDataProvider

struct org_xmlvm_iphone_CGDataProvider {
    __CLASS_DEFINITION_org_xmlvm_iphone_CGDataProvider* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_CGDataProvider;
};
#ifndef XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGDataProvider
#define XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGDataProvider
