...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarItem
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarItem \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIBarItem \
    } org_xmlvm_iphone_UIBarItem

struct org_xmlvm_iphone_UIBarItem {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIBarItem* __class;
