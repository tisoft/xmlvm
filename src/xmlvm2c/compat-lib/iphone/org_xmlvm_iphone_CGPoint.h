...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGPoint
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_CGPoint \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        JAVA_FLOAT x_; \
        JAVA_FLOAT y_; \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CGPoint \
    } org_xmlvm_iphone_CGPoint

struct org_xmlvm_iphone_CGPoint {
    __CLASS_DEFINITION_org_xmlvm_iphone_CGPoint* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_CGPoint;
};
#ifndef XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGPoint
#define XMLVM_FORWARD_DECL_org_xmlvm_iphone_CGPoint
