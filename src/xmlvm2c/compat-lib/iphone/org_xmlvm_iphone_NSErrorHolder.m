...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) org_xmlvm_iphone_NSErrorHolder_description__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
void __INIT_org_xmlvm_iphone_NSErrorHolder()
{
    ...
    if (initBegan) {
        ...
        XMLVM_CLASS_USED("org.xmlvm.iphone.NSErrorHolder")
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_NSErrorHolder)
