...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewRowAnimation
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewRowAnimation \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewRowAnimation \
    } org_xmlvm_iphone_UITableViewRowAnimation

struct org_xmlvm_iphone_UITableViewRowAnimation {
    __CLASS_DEFINITION_org_xmlvm_iphone_UITableViewRowAnimation* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UITableViewRowAnimation;
};
