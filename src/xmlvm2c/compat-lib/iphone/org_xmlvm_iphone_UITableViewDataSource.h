...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UITableViewDataSource, 8, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UITableViewDataSource)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UITableViewDataSource 8
...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UITableViewDataSource_numberOfRowsInSection___org_xmlvm_iphone_UITableView_int 7
