...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIAlertViewDelegate, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIAlertViewDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIAlertViewDelegate 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UIAlertViewDelegate_clickedButtonAtIndex___org_xmlvm_iphone_UIAlertView_int 9
