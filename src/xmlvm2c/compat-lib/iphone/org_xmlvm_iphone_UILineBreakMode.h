...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UILineBreakMode
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UILineBreakMode \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UILineBreakMode \
    } org_xmlvm_iphone_UILineBreakMode

struct org_xmlvm_iphone_UILineBreakMode {
    __CLASS_DEFINITION_org_xmlvm_iphone_UILineBreakMode* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UILineBreakMode;
};
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UILineBreakMode 11
