...
__CLASS_DEFINITION_org_xmlvm_iphone_UIDeviceBatteryState __CLASS_org_xmlvm_iphone_UIDeviceBatteryState = {
    0, // classInitialized
...
{
    __CLASS_org_xmlvm_iphone_UIDeviceBatteryState.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    __CLASS_org_xmlvm_iphone_UIDeviceBatteryState.newInstanceFunc = __NEW_INSTANCE_org_xmlvm_iphone_UIDeviceBatteryState;
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_org_xmlvm_iphone_UIDeviceBatteryState.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_org_xmlvm_iphone_UIDeviceBatteryState.numImplementedInterfaces = 0;
    __CLASS_org_xmlvm_iphone_UIDeviceBatteryState.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
...
GC_CALLBACK __DELETE_org_xmlvm_iphone_UIDeviceBatteryState(void * me, void * client_data)
{
...
{
    if (!__CLASS_org_xmlvm_iphone_UIDeviceBatteryState.classInitialized) __INIT_org_xmlvm_iphone_UIDeviceBatteryState();
    ...
    me->__class = &__CLASS_org_xmlvm_iphone_UIDeviceBatteryState;
    //XMLVM_BEGIN_WRAPPER[__NEW_org_xmlvm_iphone_UIDeviceBatteryState]
    //XMLVM_END_WRAPPER
    // Tell the GC to finalize us
    XMLVM_FINALIZE(me, __DELETE_org_xmlvm_iphone_UIDeviceBatteryState);
    return me;
}
