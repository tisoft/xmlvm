...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressViewStyle
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressViewStyle \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressViewStyle \
    } org_xmlvm_iphone_UIProgressViewStyle

struct org_xmlvm_iphone_UIProgressViewStyle {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIProgressViewStyle* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIProgressViewStyle;
};
