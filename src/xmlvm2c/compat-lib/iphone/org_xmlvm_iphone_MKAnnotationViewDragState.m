...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_MKAnnotationViewDragState_ARRAYTYPE;
...
void __INIT_IMPL_org_xmlvm_iphone_MKAnnotationViewDragState()
{
    if (!__TIB_org_xmlvm_iphone_MKAnnotationViewDragState.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MKAnnotationViewDragState_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKAnnotationViewDragState, 1);
