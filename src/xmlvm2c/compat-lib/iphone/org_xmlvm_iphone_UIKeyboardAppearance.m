...
__CLASS_DEFINITION_org_xmlvm_iphone_UIKeyboardAppearance __CLASS_org_xmlvm_iphone_UIKeyboardAppearance = {
    0, // classInitialized
...
{
    __CLASS_org_xmlvm_iphone_UIKeyboardAppearance.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    __CLASS_org_xmlvm_iphone_UIKeyboardAppearance.newInstanceFunc = __NEW_INSTANCE_org_xmlvm_iphone_UIKeyboardAppearance;
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_org_xmlvm_iphone_UIKeyboardAppearance.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_org_xmlvm_iphone_UIKeyboardAppearance.numImplementedInterfaces = 0;
    __CLASS_org_xmlvm_iphone_UIKeyboardAppearance.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
