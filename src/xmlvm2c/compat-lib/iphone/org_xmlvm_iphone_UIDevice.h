...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDevice
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDevice \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSObject; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIDevice \
    } org_xmlvm_iphone_UIDevice

struct org_xmlvm_iphone_UIDevice {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIDevice* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIDevice;
};
#ifndef XMLVM_FORWARD_DECL_org_xmlvm_iphone_UIDevice
#define XMLVM_FORWARD_DECL_org_xmlvm_iphone_UIDevice
