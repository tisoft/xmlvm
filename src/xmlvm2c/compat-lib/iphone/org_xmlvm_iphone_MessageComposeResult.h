...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MessageComposeResult
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_MessageComposeResult \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MessageComposeResult \
    } org_xmlvm_iphone_MessageComposeResult

struct org_xmlvm_iphone_MessageComposeResult {
    __CLASS_DEFINITION_org_xmlvm_iphone_MessageComposeResult* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_MessageComposeResult;
};
