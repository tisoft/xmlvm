...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_NSNumberFormatterStyle
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_NSNumberFormatterStyle \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_NSNumberFormatterStyle \
    } org_xmlvm_iphone_NSNumberFormatterStyle

struct org_xmlvm_iphone_NSNumberFormatterStyle {
    __CLASS_DEFINITION_org_xmlvm_iphone_NSNumberFormatterStyle* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_NSNumberFormatterStyle;
};
