...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CATransition_getSpeed__ 25
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_CATransition_setFillMode___java_lang_String 26
