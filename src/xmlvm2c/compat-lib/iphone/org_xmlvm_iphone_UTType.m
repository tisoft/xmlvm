...
void __INIT_IMPL_org_xmlvm_iphone_UTType()
{
    ...
    _STATIC_org_xmlvm_iphone_UTType_Image = (java_lang_String*) xmlvm_create_java_string_from_pool(2);
    _STATIC_org_xmlvm_iphone_UTType_JPEG = (java_lang_String*) xmlvm_create_java_string_from_pool(3);
    _STATIC_org_xmlvm_iphone_UTType_JPEG2000 = (java_lang_String*) xmlvm_create_java_string_from_pool(4);
    _STATIC_org_xmlvm_iphone_UTType_TIFF = (java_lang_String*) xmlvm_create_java_string_from_pool(5);
    _STATIC_org_xmlvm_iphone_UTType_PICT = (java_lang_String*) xmlvm_create_java_string_from_pool(6);
    _STATIC_org_xmlvm_iphone_UTType_GIF = (java_lang_String*) xmlvm_create_java_string_from_pool(7);
    _STATIC_org_xmlvm_iphone_UTType_PNG = (java_lang_String*) xmlvm_create_java_string_from_pool(8);
    _STATIC_org_xmlvm_iphone_UTType_QuickTimeImage = (java_lang_String*) xmlvm_create_java_string_from_pool(9);
    _STATIC_org_xmlvm_iphone_UTType_AppleICNS = (java_lang_String*) xmlvm_create_java_string_from_pool(10);
    _STATIC_org_xmlvm_iphone_UTType_BMP = (java_lang_String*) xmlvm_create_java_string_from_pool(11);
    _STATIC_org_xmlvm_iphone_UTType_ICO = (java_lang_String*) xmlvm_create_java_string_from_pool(12);
    _STATIC_org_xmlvm_iphone_UTType_AudiovisualContent = (java_lang_String*) xmlvm_create_java_string_from_pool(13);
    _STATIC_org_xmlvm_iphone_UTType_Movie = (java_lang_String*) xmlvm_create_java_string_from_pool(14);
    _STATIC_org_xmlvm_iphone_UTType_Video = (java_lang_String*) xmlvm_create_java_string_from_pool(15);
    _STATIC_org_xmlvm_iphone_UTType_Audio = (java_lang_String*) xmlvm_create_java_string_from_pool(16);
    _STATIC_org_xmlvm_iphone_UTType_QuickTimeMovie = (java_lang_String*) xmlvm_create_java_string_from_pool(17);
    _STATIC_org_xmlvm_iphone_UTType_MPEG = (java_lang_String*) xmlvm_create_java_string_from_pool(18);
    _STATIC_org_xmlvm_iphone_UTType_MPEG4 = (java_lang_String*) xmlvm_create_java_string_from_pool(19);
    _STATIC_org_xmlvm_iphone_UTType_MP3 = (java_lang_String*) xmlvm_create_java_string_from_pool(20);
    _STATIC_org_xmlvm_iphone_UTType_MPEG4Audio = (java_lang_String*) xmlvm_create_java_string_from_pool(21);
    _STATIC_org_xmlvm_iphone_UTType_AppleProtectedMPEG4Audio = (java_lang_String*) xmlvm_create_java_string_from_pool(22);
