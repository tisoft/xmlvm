...
JAVA_OBJECT __CLASS_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate_ARRAYTYPE;
...
void __INIT_IMPL_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate()
{
    if (!__TIB_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MFMessageComposeViewControllerDelegate, 1);
