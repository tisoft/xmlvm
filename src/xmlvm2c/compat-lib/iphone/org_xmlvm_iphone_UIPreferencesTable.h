...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UIPreferencesTable, 15, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_UIPreferencesTable)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_UIPreferencesTable 15
