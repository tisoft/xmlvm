...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        ...
        break;
    case 1:
        result = (JAVA_OBJECT) org_xmlvm_iphone_UIPreferencesTable_getDataSource__(receiver);
        break;
    default:
        XMLVM_INTERNAL_ERROR();
        break;
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UIPreferencesTable);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UIPreferencesTable.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UIPreferencesTable.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UIPreferencesTable);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UIPreferencesTable.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UIPreferencesTable.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_UIPreferencesTable.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.UIPreferencesTable")
...
void __INIT_IMPL_org_xmlvm_iphone_UIPreferencesTable()
{
    ...
    __TIB_org_xmlvm_iphone_UIPreferencesTable.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_UIPreferencesTable_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTable);
    __CLASS_org_xmlvm_iphone_UIPreferencesTable_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTable_1ARRAY);
    __CLASS_org_xmlvm_iphone_UIPreferencesTable_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UIPreferencesTable_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIPreferencesTable(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIPreferencesTable]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_UIPreferencesTable()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UIPreferencesTable)
org_xmlvm_iphone_UIPreferencesTable* me = (org_xmlvm_iphone_UIPreferencesTable*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_UIPreferencesTable));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIPreferencesTable(me, 0);
