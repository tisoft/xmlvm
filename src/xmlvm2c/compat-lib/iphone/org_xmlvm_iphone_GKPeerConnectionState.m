...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_GKPeerConnectionState);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_GKPeerConnectionState.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_GKPeerConnectionState.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_GKPeerConnectionState);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_GKPeerConnectionState.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_GKPeerConnectionState.classInitialized) {
                // do nothing
            }
        }
    } else {
...
void __INIT_IMPL_org_xmlvm_iphone_GKPeerConnectionState()
{
    ...
    __TIB_org_xmlvm_iphone_GKPeerConnectionState.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_GKPeerConnectionState_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerConnectionState);
    __CLASS_org_xmlvm_iphone_GKPeerConnectionState_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerConnectionState_1ARRAY);
    __CLASS_org_xmlvm_iphone_GKPeerConnectionState_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_GKPeerConnectionState_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_GKPeerConnectionState(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_GKPeerConnectionState]
    //XMLVM_END_WRAPPER
}
