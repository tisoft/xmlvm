...
void __INIT_FOR_CLASS_org_xmlvm_iphone_CAAction(__TIB_DEFINITION_TEMPLATE** interface)
{
    if (!__TIB_org_xmlvm_iphone_CAAction.classInitialized) {
        ...
        __TIB_org_xmlvm_iphone_CAAction.flags = XMLVM_TYPE_INTERFACE;
        ...
        __CLASS_org_xmlvm_iphone_CAAction_ARRAYTYPE = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_CAAction, 1);
