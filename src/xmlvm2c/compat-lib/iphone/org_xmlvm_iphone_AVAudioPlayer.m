...
static XMLVM_METHOD_REFLECTION_DATA __method_reflection_data[] = {
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/NSURL;Lorg/xmlvm/iphone/NSErrorHolder;)Lorg/xmlvm/iphone/AVAudioPlayer;",
    JAVA_NULL,
    JAVA_NULL},
    {"audioPlayerWithData",
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/NSData;Lorg/xmlvm/iphone/NSErrorHolder;)Lorg/xmlvm/iphone/AVAudioPlayer;",
    JAVA_NULL,
    JAVA_NULL},
    {"play",
    ...
    0,
    0,
    "()Lorg/xmlvm/iphone/AVAudioPlayerDelegate;",
    JAVA_NULL,
    JAVA_NULL},
    {"setDelegate",
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/AVAudioPlayerDelegate;)V",
    JAVA_NULL,
    JAVA_NULL},
    {"isPlaying",
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_AVAudioPlayer);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_AVAudioPlayer.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_AVAudioPlayer.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_AVAudioPlayer);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_AVAudioPlayer.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_AVAudioPlayer.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_AVAudioPlayer.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.AVAudioPlayer")
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_AVAudioPlayer)
org_xmlvm_iphone_AVAudioPlayer* me = (org_xmlvm_iphone_AVAudioPlayer*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_AVAudioPlayer));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_AVAudioPlayer(me, 0);
