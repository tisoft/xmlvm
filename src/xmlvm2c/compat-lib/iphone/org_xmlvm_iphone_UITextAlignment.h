...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITextAlignment
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UITextAlignment \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UITextAlignment \
    } org_xmlvm_iphone_UITextAlignment

struct org_xmlvm_iphone_UITextAlignment {
    __CLASS_DEFINITION_org_xmlvm_iphone_UITextAlignment* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UITextAlignment;
};
