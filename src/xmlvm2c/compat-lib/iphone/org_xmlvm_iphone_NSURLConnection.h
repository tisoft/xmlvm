...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSURLConnection, 9, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSURLConnection)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSURLConnection 9
