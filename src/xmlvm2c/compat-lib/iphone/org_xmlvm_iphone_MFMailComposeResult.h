...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult \
    } org_xmlvm_iphone_MFMailComposeResult

struct org_xmlvm_iphone_MFMailComposeResult {
    __CLASS_DEFINITION_org_xmlvm_iphone_MFMailComposeResult* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_MFMailComposeResult;
};
