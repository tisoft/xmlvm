...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_UIControlContentVerticalAlignment);
    if (!__TIB_org_xmlvm_iphone_UIControlContentVerticalAlignment.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_UIControlContentVerticalAlignment();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_UIControlContentVerticalAlignment);
}

void __INIT_IMPL_org_xmlvm_iphone_UIControlContentVerticalAlignment()
{
    if (!__TIB_org_xmlvm_iphone_UIControlContentVerticalAlignment.classInitializationBegan) {
...
{
    if (!__TIB_org_xmlvm_iphone_UIControlContentVerticalAlignment.classInitialized) __INIT_org_xmlvm_iphone_UIControlContentVerticalAlignment();
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UIControlContentVerticalAlignment(me);
