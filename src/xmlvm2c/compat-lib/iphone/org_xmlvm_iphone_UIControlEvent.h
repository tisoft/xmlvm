...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIControlEvent
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_UIControlEvent \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_UIControlEvent \
    } org_xmlvm_iphone_UIControlEvent

struct org_xmlvm_iphone_UIControlEvent {
    __CLASS_DEFINITION_org_xmlvm_iphone_UIControlEvent* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UIControlEvent;
};
