...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_MPMoviePlayerViewController);
    if (!__TIB_org_xmlvm_iphone_MPMoviePlayerViewController.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_MPMoviePlayerViewController();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_MPMoviePlayerViewController);
}

void __INIT_IMPL_org_xmlvm_iphone_MPMoviePlayerViewController()
{
    if (!__TIB_org_xmlvm_iphone_MPMoviePlayerViewController.classInitializationBegan) {
