...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_UISegmentedControl, 87)
...
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UISegmentedControl_setTitle___java_lang_String_int 72
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_UISegmentedControl_getTitleForSegmentAtIndex___int 73
