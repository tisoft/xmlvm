...
static XMLVM_CONSTRUCTOR_REFLECTION_DATA __constructor_reflection_data[] = {
    ...
    0,
    0,
    "(Lorg/xmlvm/iphone/CLLocationCoordinate2D;Lorg/xmlvm/iphone/MKCoordinateSpan;)V",
    JAVA_NULL,
    JAVA_NULL},
};
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_MKCoordinateRegion);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_MKCoordinateRegion.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_MKCoordinateRegion.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_MKCoordinateRegion);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_MKCoordinateRegion.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_MKCoordinateRegion.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_MKCoordinateRegion.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.MKCoordinateRegion")
...
void __INIT_IMPL_org_xmlvm_iphone_MKCoordinateRegion()
{
    ...
    __TIB_org_xmlvm_iphone_MKCoordinateRegion.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_MKCoordinateRegion_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKCoordinateRegion);
    __CLASS_org_xmlvm_iphone_MKCoordinateRegion_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKCoordinateRegion_1ARRAY);
    __CLASS_org_xmlvm_iphone_MKCoordinateRegion_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_MKCoordinateRegion_2ARRAY);
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_MKCoordinateRegion)
