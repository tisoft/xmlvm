...
GC_CALLBACK __DELETE_org_xmlvm_iphone_MPMoviePlayerController(void * me, void * client_data)
{
...
JAVA_OBJECT __NEW_org_xmlvm_iphone_MPMoviePlayerController()
{
    ...
    XMLVM_FINALIZE(me, __DELETE_org_xmlvm_iphone_MPMoviePlayerController);
    return me;
}
