...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_MFMessageComposeViewController, 91)

//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMessageComposeViewController
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_MFMessageComposeViewController \
    __INSTANCE_MEMBERS_org_xmlvm_iphone_UINavigationController; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_MFMessageComposeViewController \
    } org_xmlvm_iphone_MFMessageComposeViewController

struct org_xmlvm_iphone_MFMessageComposeViewController {
    __CLASS_DEFINITION_org_xmlvm_iphone_MFMessageComposeViewController* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_MFMessageComposeViewController;
};
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_MFMessageComposeViewController 91
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_getBody__ 85
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_setBody___java_lang_String 86
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_getRecipients__ 87
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_setRecipients___java_util_ArrayList 88
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_getMessageComposeDelegate__ 89
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_MFMessageComposeViewController_setMessageComposeDelegate___org_xmlvm_iphone_MFMessageComposeViewControllerDelegate 90
