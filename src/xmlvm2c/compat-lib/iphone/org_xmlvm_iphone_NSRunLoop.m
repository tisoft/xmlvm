...
void __INIT_IMPL_org_xmlvm_iphone_NSRunLoop()
{
    ...
    _STATIC_org_xmlvm_iphone_NSRunLoop_NSDefaultRunLoopMode = (java_lang_String*) xmlvm_create_java_string_from_pool(1);
    _STATIC_org_xmlvm_iphone_NSRunLoop_NSRunLoopCommonModes = (java_lang_String*) xmlvm_create_java_string_from_pool(2);
