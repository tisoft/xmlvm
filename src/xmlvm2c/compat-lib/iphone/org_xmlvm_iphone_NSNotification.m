...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_NSNotification);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_NSNotification.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_NSNotification.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_NSNotification);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_NSNotification.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_NSNotification.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_NSNotification.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.NSNotification")
...
void __INIT_IMPL_org_xmlvm_iphone_NSNotification()
{
    ...
    __TIB_org_xmlvm_iphone_NSNotification.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_NSNotification_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNotification);
    __CLASS_org_xmlvm_iphone_NSNotification_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNotification_1ARRAY);
    __CLASS_org_xmlvm_iphone_NSNotification_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_NSNotification_2ARRAY);
...
void __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSNotification(JAVA_OBJECT me, int derivedClassWillRegisterFinalizer)
{
    ...
    //XMLVM_BEGIN_WRAPPER[__INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSNotification]
    //XMLVM_END_WRAPPER
}

JAVA_OBJECT __NEW_org_xmlvm_iphone_NSNotification()
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_NSNotification)
org_xmlvm_iphone_NSNotification* me = (org_xmlvm_iphone_NSNotification*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_NSNotification));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_NSNotification(me, 0);
