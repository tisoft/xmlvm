...
{
    staticInitializerRecursiveLock(&__TIB_org_xmlvm_iphone_AudioServices);
    if (!__TIB_org_xmlvm_iphone_AudioServices.classInitialized) {
        __INIT_IMPL_org_xmlvm_iphone_AudioServices();
    }
    staticInitializerRecursiveUnlock(&__TIB_org_xmlvm_iphone_AudioServices);
}

void __INIT_IMPL_org_xmlvm_iphone_AudioServices()
{
    if (!__TIB_org_xmlvm_iphone_AudioServices.classInitializationBegan) {
        ...
        __CLASS_org_xmlvm_iphone_AudioServices_3ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_AudioServices, 3);
        __CLASS_org_xmlvm_iphone_AudioServices_2ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_AudioServices, 2);
        __CLASS_org_xmlvm_iphone_AudioServices_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_AudioServices, 1);
