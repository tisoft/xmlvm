...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_NSURL, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_NSURL)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_NSURL 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_NSURL_absoluteString__ 9
