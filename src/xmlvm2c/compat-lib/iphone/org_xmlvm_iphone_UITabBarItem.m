...
static JAVA_OBJECT method_dispatcher(JAVA_OBJECT method, JAVA_OBJECT receiver, JAVA_OBJECT arguments)
{
    ...
    case 0:
        result = (JAVA_OBJECT) org_xmlvm_iphone_UITabBarItem_getBadgeValue__(receiver);
        break;
    case 1:
...
{
    staticInitializerLock(&__TIB_org_xmlvm_iphone_UITabBarItem);

    // While the static initializer mutex is locked, locally store the value of
    // whether class initialization began or not
    int initBegan = __TIB_org_xmlvm_iphone_UITabBarItem.classInitializationBegan;

    // Whether or not class initialization had already began, it has begun now
    __TIB_org_xmlvm_iphone_UITabBarItem.classInitializationBegan = 1;

    staticInitializerUnlock(&__TIB_org_xmlvm_iphone_UITabBarItem);

    JAVA_LONG curThreadId = (JAVA_LONG)pthread_self();
    if (initBegan) {
        if (__TIB_org_xmlvm_iphone_UITabBarItem.initializerThreadId != curThreadId) {
            // Busy wait until the other thread finishes initializing this class
            while (!__TIB_org_xmlvm_iphone_UITabBarItem.classInitialized) {
                // do nothing
            }
        }
    } else {
        __TIB_org_xmlvm_iphone_UITabBarItem.initializerThreadId = curThreadId;
        XMLVM_CLASS_USED("org.xmlvm.iphone.UITabBarItem")
...
void __INIT_IMPL_org_xmlvm_iphone_UITabBarItem()
{
    ...
    __TIB_org_xmlvm_iphone_UITabBarItem.baseType = JAVA_NULL;
    __CLASS_org_xmlvm_iphone_UITabBarItem_1ARRAY = XMLVM_CREATE_ARRAY_CLASS_OBJECT(__CLASS_org_xmlvm_iphone_UITabBarItem);
...
{    XMLVM_CLASS_INIT(org_xmlvm_iphone_UITabBarItem)
org_xmlvm_iphone_UITabBarItem* me = (org_xmlvm_iphone_UITabBarItem*) XMLVM_MALLOC(sizeof(org_xmlvm_iphone_UITabBarItem));
    ...
    __INIT_INSTANCE_MEMBERS_org_xmlvm_iphone_UITabBarItem(me, 0);
