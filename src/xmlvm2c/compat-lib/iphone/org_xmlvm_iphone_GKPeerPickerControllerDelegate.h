...
XMLVM_DEFINE_CLASS(org_xmlvm_iphone_GKPeerPickerControllerDelegate, 10, XMLVM_ITABLE_SIZE_org_xmlvm_iphone_GKPeerPickerControllerDelegate)
...
#define XMLVM_VTABLE_SIZE_org_xmlvm_iphone_GKPeerPickerControllerDelegate 10
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerControllerDelegate_didSelectConnectionType___org_xmlvm_iphone_GKPeerPickerController_int 6
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerControllerDelegate_sessionForConnectionType___org_xmlvm_iphone_GKPeerPickerController_int 7
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerControllerDelegate_didConnectPeer___org_xmlvm_iphone_GKPeerPickerController_java_lang_String_org_xmlvm_iphone_GKSession 8
#define XMLVM_VTABLE_IDX_org_xmlvm_iphone_GKPeerPickerControllerDelegate_didCancel___org_xmlvm_iphone_GKPeerPickerController 9
