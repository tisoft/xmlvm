...
//XMLVM_BEGIN_MEMBERS
#define __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CLDeviceOrientation
//XMLVM_END_MEMBERS

#define __INSTANCE_MEMBERS_org_xmlvm_iphone_CLDeviceOrientation \
    __INSTANCE_MEMBERS_java_lang_Object; \
    struct { \
        __ADDITIONAL_INSTANCE_MEMBERS_org_xmlvm_iphone_CLDeviceOrientation \
    } org_xmlvm_iphone_CLDeviceOrientation

struct org_xmlvm_iphone_CLDeviceOrientation {
    __CLASS_DEFINITION_org_xmlvm_iphone_CLDeviceOrientation* __class;
    __INSTANCE_MEMBERS_org_xmlvm_iphone_CLDeviceOrientation;
};
