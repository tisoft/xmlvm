...
__CLASS_DEFINITION_java_lang_Math __CLASS_java_lang_Math = {
    0, // classInitialized
...
{
    __CLASS_java_lang_Math.classInitialized = 1;
    // Initialize base class if necessary
    if (!__CLASS_java_lang_Object.classInitialized) __INIT_java_lang_Object();
    // Copy vtable from base class
    XMLVM_MEMCPY(__CLASS_java_lang_Math.vtable, __CLASS_java_lang_Object.vtable, sizeof(__CLASS_java_lang_Object.vtable));
    // Initialize vtable for this class
    // Initialize vtable for implementing interfaces
    __CLASS_java_lang_Math.numImplementedInterfaces = 0;
    __CLASS_java_lang_Math.implementedInterfaces = (__CLASS_DEFINITION_TEMPLATE* (*)[1]) XMLVM_MALLOC(sizeof(__CLASS_DEFINITION_TEMPLATE*) * 0);
...
{
    if (!__CLASS_java_lang_Math.classInitialized) __INIT_java_lang_Math();
    java_lang_Math* me = (java_lang_Math*) XMLVM_MALLOC(sizeof(java_lang_Math));
    me->__class = &__CLASS_java_lang_Math;
