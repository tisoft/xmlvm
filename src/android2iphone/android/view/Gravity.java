...
public class Gravity {
     ...
     * @param container
     *            The frame of the containing space, in which the object will be
     *            placed. Should be large enough to contain the width and height
     *            of the object.
     * @param outRect
     ...
     *            of the object.
     * @param xAdj
     *            Offset to apply to the X axis. If gravity is LEFT this pushes
     *            it to the right; if gravity is RIGHT it pushes it to the left;
     *            if gravity is CENTER_HORIZONTAL it pushes it to the right or
     *            left; otherwise it is ignored.
     * @param yAdj
     ...
     * visible in the display; the gravity flags
     * {@link #DISPLAY_CLIP_HORIZONTAL} and {@link #DISPLAY_CLIP_VERTICAL} can
     * be used to change this behavior.
     * 
     * @param gravity
     *            Gravity constants to modify the placement within the display.
     * @param display
     *            The rectangle of the display in which the object is being
     *            placed.
     * @param inoutObj
     *            Supplies the current object position; returns with it modified
     *            if needed to fit in the display.
     */
    ...
    public static int parseGravity(String str, int defaultGravity) {
        int result = 0;
        int separatorIndex;
