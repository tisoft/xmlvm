...
public class Paint {
    ...
    public Paint(int flags) {
        Log.w("xmlvm", "android.graphics.Paint(int) not initializing mNativePaint");
        //mNativePaint = native_init();
        Log.w("xmlvm", "android.graphics.Paint(int) not calling setFlags(int)");
    ...
    public void setARGB(int a, int r, int g, int b) {
        Log.w("xmlvm", "android.graphics.setARGB() not calling setColor()");
...
//    }
    ...
    public void setTextSize(float textSize) {
        Log.w("xmlvm", "android.graphics.setTextSize() not implemented");
    }
    ...
    private float native_measureText(String text) {
        Log.w("xmlvm", "Paint.native_measureText() not implemented");
        return 15;
    }
