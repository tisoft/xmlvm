...
public class FrameLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSize(maxWidth, widthMeasureSpec), resolveSize(maxHeight,
                heightMeasureSpec));
    }
                ...
                if (gravity != -1) {
                    ...
                    case Gravity.CENTER_HORIZONTAL:
                        childLeft = parentLeft
                                + (parentRight - parentLeft + lp.leftMargin + lp.rightMargin - width)
                                / 2;
                        break;
                    case Gravity.RIGHT:
                    ...
                    case Gravity.CENTER_VERTICAL:
                        childTop = parentTop
                                + (parentBottom - parentTop + lp.topMargin + lp.bottomMargin - height)
                                / 2;
                        break;
                    case Gravity.BOTTOM:
     ...
     * {@link android.R.styleable#FrameLayout_Layout FrameLayout Layout
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        String str = attrs.getAttributeValue(null, "background");
        // Resolve foreground background
        if (str != null) {
            int foregroundId = attrs.getAttributeResourceValue(null, "foreground", -1);
            if (foregroundId != -1) {
                Drawable d = getContext().getResources().getDrawable(foregroundId);
                if (d != null) {
                    setForeground(d);
                }
            }
        ...
        boolean b = attrs.getAttributeBooleanValue(null, "measureAllChildren", false);
