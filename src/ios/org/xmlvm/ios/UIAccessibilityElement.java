...
@XMLVMSkeletonOnly
public class UIAccessibilityElement extends NSObject {
	 ...
	 */
	public Object getAccessibilityContainer(){
	 ...
	 * @property(nonatomic, assign) id accessibilityContainer;
	 */
	public void setAccessibilityContainer(Object accessibilityContainer){
		throw new RuntimeException("Stub");
	}
