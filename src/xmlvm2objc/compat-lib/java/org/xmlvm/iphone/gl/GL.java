...
public class GL {
	...
	public static void glTexImage2D(int tar,int level, int iformat, int width, int height, int border, int format, int type, ByteBuffer buffer) {
		buffer.flip();
	...
	public static void glViewport(int i, int j, int backingWidth,
			int backingHeight) {
	...
	public static void glOrthof(float f, float g, float h, float i, float j,
			float k) {
