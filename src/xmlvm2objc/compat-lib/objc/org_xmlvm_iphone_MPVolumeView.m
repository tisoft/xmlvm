...
#import "org_xmlvm_iphone_MPVolumeView.h"

@implementation MPVolumeView (cat_org_xmlvm_iphone_MPVolumeView)
...
{
    [self setShowsRouteButton:value];
}
...
{
    [self setShowsVolumeSlider:value];
}
