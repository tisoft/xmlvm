...
- (int) sendData___org_xmlvm_iphone_NSData_java_util_ArrayList_int_org_xmlvm_iphone_NSErrorHolder :(org_xmlvm_iphone_NSData*)n1 :(java_util_ArrayList*)n2 :(int)n3 :(org_xmlvm_iphone_NSError*)n4;
