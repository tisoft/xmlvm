...
@implementation org_xmlvm_iphone_GKSessionDelegate;
...
- (void)session:(GKSession *)session connectionWithPeerFailed:(NSString *)peerID withError:(NSError *)error {
    [self connectionWithPeerFailed___org_xmlvm_iphone_GKSession_java_lang_String_org_xmlvm_iphone_NSError:session :peerID :error];
}

- (void)session:(GKSession *)session didFailWithError:(NSError *)error {
    [self didFailWithError___org_xmlvm_iphone_GKSession_org_xmlvm_iphone_NSError:session :error];
}

- (void)session:(GKSession *)session didReceiveConnectionRequestFromPeer:(NSString *)peerID
{
    [self didReceiveConnectionRequestFromPeer___org_xmlvm_iphone_GKSession_java_lang_String:session :peerID];
}

- (void)session:(GKSession *)session peer:(NSString *)peerID didChangeState:(GKPeerConnectionState)state
{
    [self didChangeState___org_xmlvm_iphone_GKSession_java_lang_String_int:session :peerID :state];
}
