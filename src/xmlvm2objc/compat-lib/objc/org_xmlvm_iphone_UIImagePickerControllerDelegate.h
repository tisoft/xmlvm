...
#import "org_xmlvm_iphone_NSDictionary.h"
	
@interface org_xmlvm_iphone_UIImagePickerControllerDelegate : org_xmlvm_iphone_UINavigationControllerDelegate <UIImagePickerControllerDelegate>
