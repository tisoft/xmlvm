...
+ (void) mergeSort:(XMLVMArray*) src: (XMLVMArray*) dest: (int) low: (int) high: (int) off {
	[java_util_Arrays mergeSortWithComparator:src:dest:low:high:off:(java_util_Comparator*)[NSNull null]];
}
...
+ (void) sort___java_lang_Object_ARRAYTYPE: (XMLVMArray*) a {
	[java_util_Arrays sort___java_lang_Object_ARRAYTYPE_java_util_Comparator:a:(java_util_Comparator*)[NSNull null]];
}
