...
public class Arguments {
	...
	private static void usage(String error) {
		String[] msg = {
				...
				"             [--iphone-app=<app-name> [--android2iphone]]",
	...
	public Arguments(String[] argv) {
		...
		for (int i = 0; i < argv.length; i++) {
			...
			} else if (arg.equals(ARG_ANDROID_TO_IPHONE)) {
	...
	private void performSanityChecks() {
		...
		if (option_android2iphone && option_target != Targets.IPHONE)
			usage("--android2iphone requires option --target=iphone");
