...
public class OptimizationOutputProcess extends XmlvmProcessImpl {
    ...
    class ConstantPoolEntry {
        ...
        public boolean equals(Object other) {
            ...
            return other instanceof ConstantPoolEntry && this.id == o.id
                    && this.encodedString.equals(o.encodedString);
        }
    ...
    private void generateStringConstantPool(BundlePhase2 bundle) {
        ...
        for (XmlvmResource resource : bundle.getResources()) {
            ...
            for (XmlvmConstantStringElement inst : instructions) {
                ...
                if (constantPoolIDs.containsKey(encodedConstant)) {
                    ...
                    ConstantPoolEntry entry = new ConstantPoolEntry(id, len, escapedConstant,
                            encodedConstant);
        ...
        XmlvmResource resource = new XmlvmResource(XmlvmResource.Type.CONST_POOL, new Document(
                xmlRoot));
