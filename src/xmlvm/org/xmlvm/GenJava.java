...
public class GenJava
{
    ...
    /**
     * 	Creates Java binary files from the org.jdom.Document that
     *  is associated with this object.  The location for the binary
     *  files is determined by the given string path.
     */
        ...
        for (Element clazz : clazzes)
        {
	        ...
	        for (Object o : clazz.getChildren()) {
	            ...
	            if (tag.equals("method"))
	                ...
	                throw new IllegalXMLVMException("Unknown class declaration '"
	                        + tag + "'");
	        }
    ...
    private void createClass(Element clazz)
    {
        ...
        fullQualifiedClassName = packageName.equals("") ? clazzName
        ...
        _cg = new ClassGen(fullQualifiedClassName, baseClazz, fileName,
                           accessFlags, interfaces);
        ...
        throws IllegalXMLVMException
    {
        ...
        if(methodName.equals(".cctor"))  // Same concept, different names in .net/JVM.  Note we are doing init of statics for a class
        {
        ...
        MethodGen m = new MethodGen(accessFlags, retType, argTypes, null,
                                    methodName, fullQualifiedClassName, il, _cp);
    ...
    private Type collectReturnType(Element signature)
        throws IllegalXMLVMException
    {
    ...
    private Type[] collectArgumentTypes(Element signature)
        throws IllegalXMLVMException
    {
    ...
    private Type parseTypeString(String type)
        throws IllegalXMLVMException
    {
    ...
    private short getAccessFlags(Element elem)
    {
        ...
        af |= checkAccessFlag(elem, "isSynchronized",
    ...
    public Instruction createInstructionCheckcast(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionLabel(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionAconst_null(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionAload(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionInvokespecial(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionInvokevirtual(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public Instruction createInstructionInvokestatic(Element inst)
        throws IllegalXMLVMException
    {
        ...
        throws IllegalXMLVMException
    {
        ...
        Type retType = collectReturnType(signature);
        Type[] argTypes = collectArgumentTypes(signature);
        return _factory.createInvoke(classType, methodName, retType, argTypes,
                kind);
    }
    ...
    public Instruction createInstructionGetstatic(Element inst)
        throws IllegalXMLVMException
    {
        String classType = inst.getAttributeValue("class-type");
        String field = inst.getAttributeValue("field");
        Type type = parseTypeString(inst.getAttributeValue("type"));
        return _factory.createFieldAccess(classType, field, type,
                Constants.GETSTATIC);
    }



    public CompoundInstruction createInstructionLdc(Element inst)
        throws IllegalXMLVMException
    {
    ...
    public CompoundInstruction createInstructionLdc2_w(Element inst)
        throws IllegalXMLVMException
    {
        return createInstructionPush(inst);
    }
        ...
        throws IllegalXMLVMException
    {
        ...
        if (type == Type.STRING)
            ...
            throw new IllegalXMLVMException(inst.getName() + " with bad type '"
                    + t + "'");
    }
    ...
    public Instruction createInstructionIstore(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionLstore(Element inst)
    throws IllegalXMLVMException
{
    ...
    public Instruction createInstructionIload(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionLload(Element inst)
    throws IllegalXMLVMException
{
    int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionFstore(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionFload(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionDstore(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionDload(Element inst)
        throws IllegalXMLVMException
    {
        int idx = Integer.parseInt(inst.getAttributeValue("index"));
    ...
    public Instruction createInstructionIadd(Element inst)
        throws IllegalXMLVMException
    {
        return new IADD();
    }
    ...
    public Instruction createInstructionLadd(Element inst)
    throws IllegalXMLVMException
    {
    	return new LADD();
    }
    ...
    public Instruction createInstructionIsub(Element inst)
        throws IllegalXMLVMException
    {
        return new ISUB();
    }
    ...
    public Instruction createInstructionDsub(Element inst)
        throws IllegalXMLVMException
    {
        return new DSUB();
    }

    public Instruction createInstructionAaload(Element inst)
    throws IllegalXMLVMException
    {
	    return new AALOAD();
	    
	}
    public Instruction createInstructionDadd(Element inst)
        throws IllegalXMLVMException
    {
        return new DADD();
    }
    ...
    public Instruction createInstructionFadd(Element inst)
    throws IllegalXMLVMException
    {
    	return new FADD();
    }
    ...
    public Instruction createInstructionImul(Element inst)
        throws IllegalXMLVMException
    {
        return new IMUL();
    }
    ...
    public Instruction createInstructionDmul(Element inst)
        throws IllegalXMLVMException
    {
        return new DMUL();
    }
    ...
    public Instruction createInstructionIdiv(Element inst)
        throws IllegalXMLVMException
    {
        return new IDIV();
    }
    ...
    public Instruction createInstructionDdiv(Element inst)
        throws IllegalXMLVMException
    {
        return new DDIV();
    }
    ...
    public Instruction createInstructionIrem(Element inst)
        throws IllegalXMLVMException
    {
        return new IREM();
    }
    ...
    public Instruction createInstructionPutfield(Element inst)
        throws IllegalXMLVMException
    {
        String classType = inst.getAttributeValue("class-type");
        String field = inst.getAttributeValue("field");
    ...
    public Instruction createInstructionPutstatic(Element inst)
    throws IllegalXMLVMException
    {
	    String classType = inst.getAttributeValue("class-type");
	    String field = inst.getAttributeValue("field");
    ...
    public Instruction createInstructionPop(Element inst)
        throws IllegalXMLVMException
    {
        return new POP();
    }
    ...
    public Instruction createInstructionGetfield(Element inst)
        throws IllegalXMLVMException
    {
        String classType = inst.getAttributeValue("class-type");
        String field = inst.getAttributeValue("field");
